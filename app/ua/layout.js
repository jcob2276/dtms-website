...
export const metadata = {
  ...
  openGraph: {
    type: 'website',
    locale: 'uk_UA',
    url: 'https://szkoleniadtms.pl/ua',
    siteName: 'DTMS Технічне навчання',
    title: 'DTMS - Навчання UDT Кросно | Навантажувачі, Платформи, Крани',
    description: 'Професійні курси UDT у Кросно. Навчаємо операторів навантажувачів, мобільних платформ, кранів та HDS.',
  ...
  return (
    <html lang={lang} suppressHydrationWarning>
      <head>
        ...
        <Script id="delayed-tracking-ua" strategy="afterInteractive">
          {`
            (function() {
              const loadTracking = () => {
        ...
        <Script id="sw-register-ua" strategy="afterInteractive">
          {`
        ...
        <Script id="json-ld-navigation-ua" type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "ItemList",
            "itemListElement": [
              { "@type": "SiteNavigationElement", "position": 1, "name": "Start", "url": "https://szkoleniadtms.pl/ua/" },
              { "@type": "SiteNavigationElement", "position": 2, "name": "Services", "url": "https://szkoleniadtms.pl/ua/uslugi/" },
              { "@type": "SiteNavigationElement", "position": 3, "name": "Contact", "url": "https://szkoleniadtms.pl/ua/#kontakt" }
            ]
          })}
        </Script>
      </head>
